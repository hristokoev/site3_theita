<div class="comment">
	<div class="comment-header">
		...
		<span class="comment-name<?php echo ($comment["showasadmin"] == 1) ? '-admin' : ''; ?>"><?php echo ($comment["showasadmin"] == 1) ? $comment["displayname"] . ' - ' . $templatefields["txtsites"] : $comment["displayname"]; ?></span>
			...
			<?php foreach ($replies as $reply) { ?>
				<div class="reply">
					<div class="comment-header">
						...
						<span class="comment-name<?php echo ($reply["showasadmin"] == 1) ? '-admin' : ''; ?>"><?php echo ($reply["showasadmin"] == 1) ? $reply["displayname"] . ' - ' . $templatefields["txtsites"] : $reply["displayname"]; ?></span>
